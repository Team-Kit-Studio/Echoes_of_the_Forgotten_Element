...
@onready var audio_num_music_text: Label = $HBoxContainer/VBoxContainer3/Audio_Num_LBL
@onready var audio_num_sfx_text: Label= $HBoxContainer/VBoxContainer3/Audio_Num_LBL2
